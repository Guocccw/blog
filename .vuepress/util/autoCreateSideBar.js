/*
 * @Author: Guocc
 * @Date: 2022-04-15 15:45:43
 * @LastEditTime: 2022-04-15 16:09:47
 * @LastEditors: Guocc
 * @Description:
 */
/**
...
module.exports = {
  ...
  createSideBar(path = '', white_path = []) {
    ...
    let log = this.reverse(file_catalogue);
    return log;
  },
  ...
  getFileCatalogue(path = '', white_path = []) {
    ...
    catagolue_list.filter((v) => !v.includes('.md')).forEach((new_path) => this.getFileCatalogue(path + '/' + new_path, white_path));
  },
